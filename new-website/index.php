                            ...
                            <div class="col-lg-4 text-center text-lg-end">
                                <div class="d-flex justify-content-end">
                                    <div class="d-flex border-end border-primary pe-3">
                                        ...
                                        <a class="btn p-0 text-primary me-0" href="https://api.whatsapp.com/send?phone=918849787195" target="_blank" ><i class="fab fa-whatsapp" style="padding: 0 0 0 15px;"></i></a>
                                    </div>
                        ...
                        <nav class="navbar navbar-expand-lg navbar-light d-flex justify-content-lg-end">
                            ...
                            <div class="collapse navbar-collapse" id="navbarCollapse">
                                <div class="navbar-nav mx-0 mx-lg-auto bg-white">
                                    ...
                                    <a href="why-goyam.php" class="nav-item nav-link">Why Goyam</a>
                                    <div class="nav-item dropdown">
                                        <a href="#" class="nav-link" data-bs-toggle="dropdown">
                                            <span class="dropdown-toggle">Our Services</span>
                                        </a>
                                        <div class="dropdown-menu">
                                            <a href="Air-Freight.php" class="dropdown-item">Air Freight</a>
                                            <a href="Sea-Freight.php" class="dropdown-item">Sea Freight</a>
                                            <a href="custom-clearing-agent.php" class="dropdown-item">Customs Clearing Agent</a>
                                            <a href="project-logistic.php" class="dropdown-item">Project logistics</a>
                                            <a href="transportation.php" class="dropdown-item">Transportation</a>
                                            <a href="consultancy.php" class="dropdown-item">Consultancy</a>
                                            <a href="cargo-insurance.php" class="dropdown-item">Cargo Insurance</a>
                                            <a href="allied-services.php" class="dropdown-item">Allied Services</a>
                        ...
                        <div class="h-100">
                           ...
                           <!-- <p>Freight Transportation</p>
                            ...
                            <div class="text-dark mb-4">
                                 <p class="fs-5"><span class="fa fa-check text-primary me-2"></span>Competitive rates</p>
                                 <p class="fs-5"><span class="fa fa-check text-primary me-2"></span>Timely execution</p>
                                <p class="fs-5"><span class="fa fa-check text-primary me-2"></span>Strong logistics support</p>
                                 <p class="fs-5"><span class="fa fa-check text-primary me-2"></span> Custom tariff, act & procedures </p>
                                 <p class="fs-5"><span class="fa fa-check text-primary me-2"></span>Vast distribution network</p>
                           <!-- <p class="fs-5"><span class="fa fa-check text-primary me-2"></span>Expert team of professionals</p>
                                <p class="fs-5"><span class="fa fa-check text-primary me-2"></span>Strict quality standards</p>
                                <p class="fs-5"><span class="fa fa-check text-primary me-2"></span>Custom tariff, act & procedures</p>
                                <p class="fs-5"><span class="fa fa-check text-primary me-2"></span>Vast distribution network</p-->
                        ...
                        <ul class="nav">
                            ...
                            <li class="nav-item me-lg-0 mb-4">
                                <a class="py-3 px-5" data-bs-toggle="pill" href="#ServiceTab-3">
                                    <span>Customs Clearing Agent</span>
                                </a>
                            </li>
                            <li class="nav-item me-lg-0 mb-4">
                                <a class="py-3 px-5" data-bs-toggle="pill" href="#ServiceTab-4">
                                    <span>Project logistics</span>
                                </a>
                            </li>
                             <li class="nav-item me-lg-0 mb-4">
                                <a class="py-3 px-5" data-bs-toggle="pill" href="#ServiceTab-5">
                                    <span>Transportation</span>
                                </a>
                            </li>
                            <li class="nav-item me-lg-0 mb-4">
                                <a class="py-3 px-5" data-bs-toggle="pill" href="#ServiceTab-6">
                                    <span>Consultancy</span>
                                </a>
                            </li>
                            <li class="nav-item me-lg-0 mb-4">
                                <a class="py-3 px-5" data-bs-toggle="pill" href="#ServiceTab-7">
                                    <span>Cargo Insurance</span>
                                </a>
                            </li>
                            <li class="nav-item me-lg-0 mb-4">
                                <a class="py-3 px-5" data-bs-toggle="pill" href="#ServiceTab-8">
                    ...
                    <div class="col-lg-9 wow fadeInRight" data-wow-delay="0.3s">
                        <div class="tab-content">
                            <div id="ServiceTab-1" class="tab-pane fade show p-0 active">
                                <div class="service-carousel owl-carousel">
                                    <div class="service-item">
                                        <img src="img/air.png" class="img-fluid w-100" alt="">
                                        <div class="border border-top-0 p-4">
                                            <h4 class="mb-3">Air Freight</h4>
                                            <p class="mb-4">Air freight plays a crucial role in global logistics, offering fast and efficient transportation solutions for time-sensitive cargo. With its ...
                                            </p>
                                            <a class="btn btn-primary py-2 px-4" href="Air-Freight.php">Read More</a>
                                        </div>
                                    </div>
                                    <div class="service-item">
                                        <img src="img/sea-freight.jpg" class="img-fluid w-100" alt="">
                                        <div class="border border-top-0 p-4">
                                            <h4 class="mb-3">Sea Freight</h4>
                                            <p class="mb-4">Sea freight is a vital component of global trade, offering cost-effective and reliable transportation solutions for goods across vast distances...
                                            </p>
                                            <a class="btn btn-primary py-2 px-4" href="Sea-Freight.php">Read More</a>
                                        </div>
                                    </div>
                                    <div class="service-item">
                                        <img src="img/custombg-resp.jpg" class="img-fluid w-100" alt="">
                                        <div class="border border-top-0 p-4">
                                            <h4 class="mb-3">Customs Clearing Agent</h4>
                                            <p class="mb-4">Customs clearance is a critical aspect of international trade, ensuring that goods can move seamlessly across borders while...
                                            </p>
                                            <a class="btn btn-primary py-2 px-4" href="custom-clearing-agent.php">Read More</a>
                                        </div>
                                    </div>
                                    <div class="service-item">
                                        <img src="img/project-log.png" class="img-fluid w-100" alt="">
                                        <div class="border border-top-0 p-4">
                                            <h4 class="mb-3">Project logistics</h4>
                                            <p class="mb-4">Project Cargo services are essential for businesses undertaking large-scale projects, requiring meticulous ...
                                            </p>
                                            <a class="btn btn-primary py-2 px-4" href="project-logistic.php">Read More</a>
                                        </div>
                                    </div>
                                    <div class="service-item">
                                        <img src="img/transpotation.jpg" class="img-fluid w-100" alt="">
                                        <div class="border border-top-0 p-4">
                                            <h4 class="mb-3">Transportation</h4>
                                            <p class="mb-4">Road transportation plays a pivotal role in the logistics industry, offering flexible and cost-effective solutions for...
                                            </p>
                                            <a class="btn btn-primary py-2 px-4" href="transportation.php">Read More</a>
                                        </div>
                                    </div>
                                    <div class="service-item">
                                        <img src="img/consultancy - home.jpg" class="img-fluid w-100" alt="">
                                        <div class="border border-top-0 p-4">
                                            <h4 class="mb-3">Consultancy</h4>
                                            <p class="mb-4">Import and export consultancy services are essential for businesses seeking to navigate the intricate landscape of...
                                            </p>
                                            <a class="btn btn-primary py-2 px-4" href="consultancy.php">Read More</a>
                                        </div>
                                    </div>
                                     <div class="service-item">
                                        <img src="img/cargo-insurences-home.png" class="img-fluid w-100" alt="">
                                        <div class="border border-top-0 p-4">
                                            <h4 class="mb-3">Cargo Insurance</h4>
                                            <p class="mb-4">Cargo insurance is a crucial service offered by GOYAM Logistics, ensuring the protection and safety of goods during transit...
                                            </p>
                                            <a class="btn btn-primary py-2 px-4" href="cargo-insurance.php">Read More</a>
                                        </div>
                                    </div>
                                    <div class="service-item">
                           ...
                           <!-- <div id="ServiceTab-2" class="tab-pane fade show p-0">
                                <div class="service-carousel owl-carousel">
                                    <div class="service-item">
                                        <img src="img/project-logistic-home.jpg" class="img-fluid w-100" alt="">
                                        <div class="border border-top-0 p-4">
                                            <h4 class="mb-3">Project logistics</h4>
                                    ...
                                    <div class="service-item">
                                     ...
                                     <div class="service-item">
                                        <img src="img/cargo-insurences.jpg" class="img-fluid w-100" alt="">
                                        <div class="border border-top-0 p-4">
                                            <h4 class="mb-3">Cargo Insurance</h4>
                                            <p class="mb-4">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Exercitationem, beatae ex. Id esse autem ratione vero cupiditate tempora recusandae est!
                                            </p>
                                    ...
                                    <div class="service-item">
                                        <img src="img/allied.jpg" class="img-fluid w-100" alt="">
                                        <div class="border border-top-0 p-4">
                                            <h4 class="mb-3">Allied Services</h4>
                                            <p class="mb-4">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Exercitationem, beatae ex. Id esse autem ratione vero cupiditate tempora recusandae est!
                                            </p>
                            ...
                            <!--<div id="ServiceTab-5" class="tab-pane fade show p-0">
                                <div class="service-carousel owl-carousel">
                                    <div class="service-item">
                                        <img src="img/industrial-1.jpg" class="img-fluid w-100" alt="">
                                        <div class="border border-top-0 p-4">
                            ...
                            <div id="ServiceTab-6" class="tab-pane fade show p-0">
                                <div class="service-carousel owl-carousel">
                                    <div class="service-item">
                                        <img src="img/industrial-1.jpg" class="img-fluid w-100" alt="">
                                        <div class="border border-top-0 p-4">
                            ...
                            <div id="ServiceTab-7" class="tab-pane fade show p-0">
                                <div class="service-carousel owl-carousel">
                                    <div class="service-item">
                                        <img src="img/industrial-1.jpg" class="img-fluid w-100" alt="">
                                        <div class="border border-top-0 p-4">
                            ...
                            <div id="ServiceTab-8" class="tab-pane fade show p-0">
                                <div class="service-carousel owl-carousel">
                                    <div class="service-item">
                                        <img src="img/industrial-1.jpg" class="img-fluid w-100" alt="">
                                        <div class="border border-top-0 p-4">
                        ...
                        <div class="tab-content">
                            <div id="ProjectsTab-1" class="tab-pane fade show p-0 active">
                                <div class="projects-item">
                                    <img src="img/safe-secure.png" class="img-fluid w-100" alt="">
                                    <div class="projects-content bg-white p-4">
                                        <h4 class="mb-3">Why Choose Us for Safe & Secure Deliveries?</h4>
                                        <p class="mb-4">At Goyam Logistics, we prioritize the safety and security of your shipments at every step of the journey. Our advanced logistics solutions ensure your goods are handled with the utmost care, from pickup to final delivery.
                                        </p>
                            ...
                            <div id="ProjectsTab-2" class="tab-pane fade show p-0">
                                <div class="projects-item">
                                    <img src="img/transport-optimization.png" class="img-fluid w-100" alt="">
                                    <div class="projects-content bg-white p-4">
                                        <h4 class="mb-3">Our Approach to Transport Optimization</h4>
                                        <p class="mb-4">Maximize efficiency and minimize costs with our transport optimization solutions at Goyam Logistics. We streamline your logistics operations by leveraging advanced technology, data analytics, and strategic planning to deliver smarter, faster, and more sustainable transportation outcomes.
                                        </p>
                                        <a class="btn btn-primary py-2 px-4" href="#">Read More</a>
                                    </div>
                                </div>
                            ...
                            <div id="ProjectsTab-3" class="tab-pane fade show p-0">
                                <div class="projects-item">
                                    <img src="img/Most-Competitive-Rates-for-Customized-Solutions.png" class="img-fluid w-100" alt="">
                                    <div class="projects-content bg-white p-4">
                                        <h4 class="mb-3">Most Competitive Rates for Customized Solutions</h4>
                                        <p class="mb-4">At Goyam Logistics, we believe in delivering value without compromising quality. Our logistics solutions are designed to meet your unique needs at the most competitive rates in the industry.
                                        </p>
                                         <a class="btn btn-primary py-2 px-4" href="contact.php">Contact Us</a>
                                    </div>
                                </div>
                            ...
                            <div id="ProjectsTab-4" class="tab-pane fade show p-0">
                                <div class="projects-item">
                                    <img src="img/cost-saving.png" class="img-fluid w-100" alt="">
                                    <div class="projects-content bg-white p-4">
                                        <h4 class="mb-4">Cost Savings Solutions</h4>
                                        <p class="mb-4">At Goyam Logistics, we prioritize efficiency to help you save costs while maintaining top-tier logistics services. Our innovative strategies and cutting-edge technology are designed to optimize your supply chain, reduce waste, and improve overall profitability.
                                        </p>
                                       <a class="btn btn-primary py-2 px-4" href="contact.php">Contact Us</a>
                                    </div>
                                </div>
            ...
            <div class="container py-5">
                <div class="row g-5">
                    <div class="col-lg-6 col-xl-5 wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <h1 class="display-4 text-white mb-4"> Powerful Praise Heard from Our Customers</h1>
                       <!-- <p class="mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Mollitia hic aspernatur unde magnam necessitatibus provident iusto maxime nobis esse eligendi.
                        ...
                        <a class="btn btn-light py-3 px-5" href="contact.php">Contact Us</a>
                    </div>
                        ...
                        <div class="owl-carousel testimonial-carousel">
                            <div class="testimonial-item">
                                ...
                                <div class="customer-text p-4">
                                    <p class="mb-0" style="color:white">The transportation service was seamless! Our goods were delivered on time and in perfect condition. The team’s professionalism and punctuality exceeded our expectations. Highly recommended!
</p>
                                </div>
                            </div>
                             ...
                             <div class="testimonial-item">
                                ...
                                <div class="customer-text p-4">
                                    <p class="mb-0" style="color:white">Their custom clearance and freight forwarding services saved us so much time and hassle. They handled everything efficiently, keeping us updated every step of the way. Truly a dependable partner!"
                            ...
                            <div class="testimonial-item">
                                ...
                                <div class="customer-text p-4">
                                    <p class="mb-0" style="color:white">Their transporting service was top-notch! From pickup to delivery, the team ensured our cargo was handled with care and arrived promptly. Excellent work!
</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row g-5">
                    <div class="col-lg-6 wow fadeInLeft" data-wow-delay="0.2s">-->
                       <!-- <h4 class="text-primary">Some Important FAQ's</h4>-->
                        <!--<h1 class="display-4 mb-4">Our core values for Goyam Logistics</h1>
                        <p class="mb-4">At Goyam Logistics, we are driven by a commitment to excellence, integrity, and innovation. These core values shape every aspect of our operations, ensuring that we provide exceptional logistics solutions to our clients.
                        </p>
                ...
                <div class="row g-5 mb-5 align-items-center">
                   ...
                   <div class="col-lg-5">
                        <div class="d-flex align-items-center justify-content-center justify-content-lg-end">
                            <a class="btn btn-light btn-md-square me-3" href="https://www.facebook.com/profile.php?id=61565034779815&mibextid=LQQJ4d" target="_blank"><i class="fab fa-facebook-f"></i></a>
                           
                            <a class="btn btn-light btn-md-square me-3" href="https://www.instagram.com/goyam.logistics?igsh=amFtOXlnc2Zvb2s3&utm_source=qr" target="_blank"><i class="fab fa-instagram"></i></a>
                            <a class="btn btn-light btn-md-square me-0" href="https://www.linkedin.com/company/goyam-logistics/" target="_blank"><i class="fab fa-linkedin-in"></i></a>
                             <a class="btn btn-light btn-md-square me-0" href="https://api.whatsapp.com/send?phone=918849787195" target="_blank" style="margin: 0 0px 0px 17px;"><i class="fab fa-whatsapp"></i></a>
                        </div>
                ...
                <div class="row g-5">
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <div class="footer-item d-flex flex-column">
                            ...
                            <a href="why-goyam.php">Why Goyam</a>
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <div class="footer-item d-flex flex-column">
                            ...
                            <a href="Sea-Freight.php"> Sea Freight</a>
                            <a href="custom-clearing-agent.php"> Customs Clearing Agent</a>
                             <a href="transportation.php">Transportation</a>
                             <a href="cargo-insurance.php">Cargo Insurance</a>
                             <a href="project-logistic.php"> Project logistics</a>
                             <a href="consultancy.php">Import Export Consultancy</a>
                            <a href="allied-services.php">Allied Services</a>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <div class="footer-item d-flex flex-column">
                            <h4 class="text-white mb-4">Contact Info</h4>
                            <a href="#"><i class="fa fa-map-marker-alt text-primary me-2"></i>611, West Wing, Venus Stratum, Opp. Jhansi Ki Rani Statue, Nehru Nagar, Ahmedabad – 380015 INDIA</a>
                            <a href="mailto:info@example.com"><i class="fas fa-envelope text-primary me-2"></i>rishabh@goyam.net.in</a>
                           
                            <a href="tel:+918849787195"><i class="fas fa-phone text-primary me-2"></i> +91 8849787195</a>
                            <a href="tel:+919978407502" class="mb-3"><i class="fas fa-phone text-primary me-2"></i>+91 9978407502</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row g-4 align-items-center">
                    <div class="col-md-6 text-center text-md-start mb-md-0">
                        <span class="text-body"><a href="#" class="border-bottom text-white"><i class="fas fa-copyright text-light me-2"></i>Goyam Logistics</a>, All right reserved.</span>
                    </div>
                    <div class="col-md-6 text-center text-md-end text-body">
                        <!--/*** This template is free as long as you keep the below author’s credit link/attribution link/backlink. ***/-->
                        <!--/*** If you'd like to use the template without the below author’s credit link/attribution link/backlink, ***/-->
                        <!--/*** you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". ***/-->
                        Designed By <a class="border-bottom text-white" href="https://dixitglobaltech.com/" target="_blank">Dixit Global Tech IT Solutions Pvt. Ltd.</a>
                    </div>
                </div>
            </div>
        </div>
