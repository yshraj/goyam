                            ...
                            <ul class="nav">
                                <li class="nav-item bg-white mb-4 w-100">
                                    <a class="d-flex align-items-center h4 mb-0 p-3 active" data-bs-toggle="pill" href="#ProjectsTab-1">
                                        <div class="projects-icon btn-md-square bg-primary text-white me-3"><span class="fas fa-warehouse small"></span></div><span>Our Mission</span>
                                    </a>
                                </li>
                                <!--<li class="nav-item bg-white mb-4 w-100">
                                ...
                                <li class="nav-item bg-white mb-4 w-100">
                                    <a class="d-flex align-items-center h4 mb-0 p-3" data-bs-toggle="pill" href="#ProjectsTab-3">
                                        <div class="projects-icon btn-md-square bg-primary text-white me-3"><span class="fas fa-ship small"></span></div><span>Our Vision</span>
                                    </a>
                                </li>
                                <!--<li class="nav-item bg-white mb-4 w-100">
