...
<!-- Navbar & Hero Start -->
        ...
        <div class="container-fluid bg-breadcrumb">
            <div class="container text-center py-5" style="max-width: 900px;">
                <!--<h4 class="text-white display-4 mb-4 wow fadeInDown" data-wow-delay="0.1s">PROJECT LOGISTIC</h4>-->
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="headingOne">
                                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                            Q: How can I get a quote for my project cargo shipment with Goyam Logistics?
                                        </button>
                                    </h2>
                                    <div id="collapseOne" class="accordion-collapse collapse show active" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            A:Getting a quote is easy! Simply reach out to Goyam Logistics with details about your project cargo, including dimensions, weight, origin, and destination. Our team will work with you to create a tailored logistics plan and provide an accurate, competitive quote.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="headingTwo">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                            Q: How does Goyam Logistics handle oversized or heavy cargo?
                                        </button>
                                    </h2>
                                    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            A:At Goyam Logistics, we have the expertise and equipment to manage the transportation of large or heavy cargo. We plan each project meticulously, ensuring the use of specialized transport like cranes, flatbed trucks, or heavy-lift vessels, and coordinate all logistics to ensure safe delivery.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="headingThree">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                            Q: Can Goyam Logistics handle complex, multi-modal project cargo shipments?
                                        </button>
                                    </h2>
                                    <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            A:Absolutely! Goyam Logistics excels at managing multi-modal shipments, combining sea, air, and land transport to optimize the route and timeline. Whether it's moving equipment from a factory to a construction site or large machinery across countries, we provide a tailored solution that meets your needs.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="headingFour">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                                            Q:How does Goyam Logistics ensure that project cargo is delivered on time?
                                        </button>
                                    </h2>
                                    <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            A: We understand that time is critical in project management. Goyam Logistics creates detailed schedules, handles customs clearance swiftly, and monitors shipments throughout the entire journey, making sure your cargo arrives on time, every time, and without unnecessary delays.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="headingFive">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
                                            Q:What industries can benefit from Goyam Logistics' project cargo services?
                                        </button>
                                    </h2>
                                    <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            A: Our Project Cargo services are ideal for industries such as construction, oil & gas, energy, mining, and manufacturing. Goyam Logistics has extensive experience supporting these sectors with tailored logistics solutions for their large, heavy, and complex shipments.
                                        </div>
                                    </div>
                                </div>
