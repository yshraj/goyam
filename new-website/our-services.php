            ...
            <div class="container py-5">
                ...
                <div class="row g-4">
                    <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="blog-item">
                            <div class="blog-img">
                                <img src="img/Air-Freight.png" class="img-fluid w-100" alt="">
                            </div>
                            <div class="blog-heading ms-4">
                                <a href="#" class="h4 mb-0 p-4">Air Freight</a>
                            </div>
                    ...
                    <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.4s">
                        <div class="blog-item">
                            <div class="blog-img">
                                <img src="img/sea-freight.png" class="img-fluid w-100" alt="">
                            </div>
                            <div class="blog-heading ms-4">
                                <a href="#" class="h4 mb-0 p-4">Sea Freight </a>
                            </div>
                            <div class="blog-content bg-light p-4">
                                <!--<div class="d-flex justify-content-between mb-4">
                                    <p class="mb-0 small"><i class="fa fa-calendar me-2"></i> April 2,2025</p>
                    ...
                    <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.6s">
                        <div class="blog-item">
                            ...
                            <div class="blog-heading ms-4">
                                <a href="#" class="h4 mb-0 p-4">Customs Clearing Agent</a>
                            </div>
                            <div class="blog-content bg-light p-4">
                               <!-- <div class="d-flex justify-content-between mb-4">
                                    <p class="mb-0 small"><i class="fa fa-calendar me-2"></i> April 2,2025</p>
                    ...
                    <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.6s">
                        <div class="blog-item">
                            ...
                            <div class="blog-heading ms-4">
                                <a href="#" class="h4 mb-0 p-4">Project logistics</a>
                            </div>
                            <div class="blog-content bg-light p-4">
                               <!-- <div class="d-flex justify-content-between mb-4">
                                    <p class="mb-0 small"><i class="fa fa-calendar me-2"></i> April 2,2025</p>
                    ...
                    <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.6s">
                        <div class="blog-item">
                            <div class="blog-img">
                                <img src="img/Transportation.png" class="img-fluid w-100" alt="">
                            </div>
                            <div class="blog-heading ms-4">
                                <a href="#" class="h4 mb-0 p-4">Transportation</a>
                            </div>
                            <div class="blog-content bg-light p-4">
                               <!-- <div class="d-flex justify-content-between mb-4">
                                    <p class="mb-0 small"><i class="fa fa-calendar me-2"></i> April 2,2025</p>
                    ...
                    <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.6s">
                     ...
                     <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.6s">
                        <div class="blog-item">
                            ...
                            <div class="blog-heading ms-4">
                                <a href="#" class="h4 mb-0 p-4">Cargo Insurance</a>
                            </div>
                            <div class="blog-content bg-light p-4">
                               <!-- <div class="d-flex justify-content-between mb-4">
                                    <p class="mb-0 small"><i class="fa fa-calendar me-2"></i> April 2,2025</p>
                    ...
                    <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.6s">
                        <div class="blog-item">
                            ...
                            <div class="blog-heading ms-4">
                                <a href="#" class="h4 mb-0 p-4">Allied Services</a>
                            </div>
                            <div class="blog-content bg-light p-4">
                               <!-- <div class="d-flex justify-content-between mb-4">
                                    <p class="mb-0 small"><i class="fa fa-calendar me-2"></i> April 2,2025</p>
                        ...
                        <div class="owl-carousel testimonial-carousel">
                            <div class="testimonial-item">
                                ...
                                <div class="customer-text p-4">
                                    <p class="mb-0">The transportation service was seamless! Our goods were delivered on time and in perfect condition. The team’s professionalism and punctuality exceeded our expectations. Highly recommended!
</p>
                                </div>
                            </div>
                            <div class="testimonial-item">
                                ...
                                <div class="customer-text p-4">
                                    <p class="mb-0">Their custom clearance and freight forwarding services saved us so much time and hassle. They handled everything efficiently, keeping us updated every step of the way. Truly a dependable partner!"</p>
                                </div>
                            </div>
                            <div class="testimonial-item">
                                <div class="testimonial-quote"><i class="fa fa-quote-right fa-2x"></i>
                                ...
                                <div class="customer-text p-4">
                                    <p class="mb-0">We’ve used their air and ocean freight services for multiple shipments, and they’ve always delivered. The process was smooth, cost-effective, and stress-free. Fantastic service!"
</p>
                                </div>
                            </div>
                            <div class="testimonial-item">
                                ...
                                <div class="customer-text p-4">
                                    <p class="mb-0">Their transporting service was top-notch! From pickup to delivery, the team ensured our cargo was handled with care and arrived promptly. Excellent work!
</p>
                                </div>
                            </div>
                        </div>
