      ...
      <!-- Navbar & Hero Start -->
        ...
        <div class="container-fluid bg-breadcrumb">
            <div class="container text-center py-5" style="max-width: 900px;">
                <!--<h4 class="text-white display-4 mb-4 wow fadeInDown" data-wow-delay="0.1s">TRANSPORTATION</h4>-->
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="headingOne">
                                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                            Q: 1. What types of transportation services do you offer?
                                        </button>
                                    </h2>
                                    <div id="collapseOne" class="accordion-collapse collapse show active" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            A: We offer a wide range of transportation options including full truckload (FTL), less-than-truckload (LTL), and specialized services for delicate or oversized cargo. Whether it’s local, regional, or long-distance shipping, we have the right solution for you.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            A: At Goyam Logistics, we provide real-time shipment tracking through our advanced tracking system. You can easily monitor the status of your delivery via our website or mobile app, ensuring transparency and peace of mind every step of the way.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            A: We provide transportation services across a wide range of regions, from local deliveries to national and international shipping. No matter where your goods need to go, we’ve got you covered.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="headingFour">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                                            Q: How do I know if my cargo requires special handling?
                                        </button>
                                    </h2>
                                    <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            A: If you’re shipping fragile, hazardous, or oversized goods, our team will advise you on the best solution to ensure safe and compliant transportation. Simply contact us with your requirements, and we’ll recommend the appropriate service.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="headingFive">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
                                            Q: Can I customize my transportation plan?
                                        </button>
                                    </h2>
                                    <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            A: Absolutely! We understand that each business has unique needs. We offer customizable transportation solutions tailored to your schedule, budget, and shipment specifics. Just let us know your preferences, and we’ll create a plan that works for you.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="headingSix">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
                                            Q: What’s the process for getting a transportation quote?
                                        </button>
                                    </h2>
                                    <div id="collapseSix" class="accordion-collapse collapse" aria-labelledby="headingSix" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            A: Getting a quote is simple! Reach out to us through our website or call our customer service team. Provide details about your shipment (size, destination, type of cargo) and we’ll send you a competitive, transparent quote in no time.
                                        </div>
                                    </div>
                                </div>
