                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="headingOne">
                                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                            Q:  Q: How does Goyam Logistics ensure my sea freight shipment is timely and secure?
                                        </button>
                                    </h2>
                                    <div id="collapseOne" class="accordion-collapse collapse show active" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            A:Goyam Logistics uses trusted global carriers, advanced tracking technology, and a dedicated team to ensure your sea freight is delivered on time and in perfect condition, no matter where it’s headed.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="headingTwo">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                            Q: What are the benefits of using sea freight with Goyam Logistics?
                                        </button>
                                    </h2>
                                    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            A: Sea freight through Goyam Logistics is a cost-effective solution for larger shipments. With our end-to-end service, from booking to delivery, you can enjoy peace of mind knowing we handle everything efficiently and professionally.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="headingThree">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                            Q: What makes Goyam Logistics different from other sea freight providers?
                                        </button>
                                    </h2>
                                    <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            A: At Goyam Logistics, we’re not just about moving cargo—we’re about creating a seamless shipping experience. We tailor each sea freight solution to your specific needs, offering personalized support and flexibility to meet your deadlines and budget.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="headingFour">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                                            Q: Can Goyam Logistics assist with packaging for sea freight?
                                        </button>
                                    </h2>
                                    <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            A:Yes! Goyam Logistics can provide expert guidance on packaging requirements to ensure your goods are safe and compliant with regulations during sea transport. We can also arrange specialized packaging if needed.
                                        </div>
                                    </div>
                                </div>
